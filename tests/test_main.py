...
def test_main_returns_2_when_no_args(monkeypatch):
    from market_analysis_engine import __main__ as main_module
...
#         runpy.run_module("market_analysis_engine.__main__", run_name="__main__")
#
...
#     import pytest
#
#     from market_analysis_engine import entrypoints
...
def test_main_module_raises_system_exit_when_run_as_script(monkeypatch):
    ...
    sys.modules.pop("market_analysis_engine.__main__", None)
