...
from market_analysis_engine.runtime.buildruntime import build_runtime
from market_analysis_engine.runtime.runtime import AppPaths, MetaInfo
...
def test_build_runtime_uses_defaults_and_calls_path_helpers(
    ...
    monkeypatch.setattr(
        "market_analysis_engine.runtime.buildruntime.read_metadata",
        lambda: meta,
    )
    monkeypatch.setattr(
        "market_analysis_engine.runtime.buildruntime.get_app_paths",
        lambda: paths,
    )
    ...
    monkeypatch.setattr(
        "market_analysis_engine.runtime.buildruntime.ensure_dirs",
        fake_ensure_dirs,
    )
    monkeypatch.setattr(
        "market_analysis_engine.runtime.buildruntime.ensure_optional_dirs",
        fake_ensure_optional_dirs,
    )
    monkeypatch.setattr(
        "market_analysis_engine.runtime.buildruntime.RuntimeSettings.load",
        fake_load,
    )
    ...
    assert runtime.db.db_dbname == "market_analysis_engine"
...
def test_build_runtime_applies_overrides_and_builds_config(
    ...
    monkeypatch.setattr(
        "market_analysis_engine.runtime.buildruntime.build_config_file",
