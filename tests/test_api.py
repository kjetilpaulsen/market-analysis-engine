...
from market_analysis_engine.api.api import (
    api,
    APIRunRequest,
    APICommand,
...
from market_analysis_engine.events.events import Event, EvtError, EvtLog, EvtProgress, EvtResult
...
def test_run_endpoint_returns_500_when_runtime_not_initialized(monkeypatch: pytest.MonkeyPatch):
    from market_analysis_engine.api import api as api_module
