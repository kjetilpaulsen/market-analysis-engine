...
from market_analysis_engine.utils.utils import compact_dict, load_dotenv_if_present, resolve_version
...
def test_resolve_version_returns_installed_version(monkeypatch):
    from market_analysis_engine.utils import utils as utils_module
...
def test_load_dotenv_if_present_loads_repo_root_env(monkeypatch, tmp_path):
    ...
    nested_file = project_root / "src" / "market_analysis_engine" / "utils" / "utils.py"
